...
3. Entra en plan mode y propone cómo implementarlo (sigue las convenciones de AGENTS.md si existen).
4. En cuanto el usuario apruebe el plan: mueve el ticket a "En curso".
5. Al terminar (con el PR ya creado siguiendo las reglas de AGENTES.md): mueve el ticket a "En revisión" y deja un comentario en el ticket con el enlace al PR.