...
Antes de nada lee `REVIEW.md`: fija qué es grave aquí, el tope de sugerencias, dónde
no se reporta y la exigencia de citar `fichero:línea`. Manda sobre estas instrucciones.
