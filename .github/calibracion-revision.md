...
Las comprobaciones deterministas de `verificacion.yml` -tipos, lint, 72 pruebas de backend, 28 de frontend, los quince contrastes del verificador- **sí bloquean**, porque su respuesta no depende del día: o el contrato coincide con el código o no.
